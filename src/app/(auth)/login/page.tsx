  ...
  useEffect(() => {
	...
	return (
		...
		<div className="relative bg-gray-700/20 h-120 w-120 border-2 border-cor-texto-principal/10 rounded-lg shadow-xl shadow-cor-texto-principal/10">
			...
			<div className="inputBox relative w-96 mt-9">
				<input value={password}  onChange={handlePasswordChange} type="text" className="relative w-96 pt-5 px-2.5 pb-2.5 bg-transparent border-none outline-none text-base tracking-wider z-20" required></input>
